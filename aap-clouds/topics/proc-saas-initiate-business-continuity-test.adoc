...
. Red Hat will coordinate with you in the support ticket to confirm the failover was successful.
...
. Red Hat will initiate the rollback to the primary region. After verifying with you that the environment is working as intended, Red Hat will close the support case.