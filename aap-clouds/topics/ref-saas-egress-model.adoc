...
For help with configuring your {AutomationMesh} see link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform//assembly-automation-mesh-operator-aap#proc-define-mesh-node-types[Defining automation mesh node types].
