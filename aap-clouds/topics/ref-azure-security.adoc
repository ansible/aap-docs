...
[id="ref-aap-security_{context}"]

= Security

[role="_abstract"]
>Review the security posture of {AAPonAzureNameShort}, including end-to-end encryption, API authorization, key management, and SRE maintenance practices.
