...
= Peer a VWAN Hub to the {AAPonAzureNameShort} Network
...
* link:https://learn.microsoft.com/en-us/azure/virtual-wan/howto-connect-vnet-hub[Connect a virtual network to a Virtual WAN hub - portal]
