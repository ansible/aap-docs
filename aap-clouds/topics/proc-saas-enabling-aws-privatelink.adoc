...
. Click btn:[Continue].
. Copy the values from the following templates into the *Title* and *Describe your problem* sections of the support request.
.. To enable {AWSPrivateLink} connectivity from control plane to customer's network use:
+
----
Title:
...
----
.. To enable {AWSPrivateLink} connectivity from customer's network to control plane use: 
+
----
Title:
Ansible Automation Platform Service on AWS PrivateLink Template
