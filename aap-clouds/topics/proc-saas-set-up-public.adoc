...
[role="_abstract"]
To set up {SaaSonAWS} you must link your {AWS} (AWS) and Red{nbsp}Hat accounts through the {Market}.
...
. Select btn:[Click here to set up your account]. This redirects you to {RHSSO} where you must:
