...
= Configure direct network peering

[role="_abstract"]
Configure network peering between your Azure network and your VNet in the *Virtual Networks* page of the Azure Portal. 
...
* link:https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-manage-peering#create-a-peering[Create a peering]
* link:https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-peering-overview[Virtual network peering]
