...
= Create a service principal for automating Azure resources

[role="_abstract"]
Create a service principal in Microsoft Entra ID using Azure Cloud Shell to allow {PlatformNameShort} to authenticate and manage your Azure resources.

You must provide authorization credentials after deployment.
...
. Click the link:https://learn.microsoft.com/en-us/azure/cloud-shell/overview[Cloud Shell] icon to open a bash Cloud Shell in your browser.
