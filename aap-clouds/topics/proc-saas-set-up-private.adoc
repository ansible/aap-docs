...
[role="_abstract"]
Accept a private offer from {Market} and link your AWS and Red Hat accounts to provision your {PlatformName} environment.
...
. Select btn:[Click Set up your account]. This redirects you to {RHSSO} where you must:
...
If you did not receive the email or the initial admin password has expired, you must submit a link:https://access.redhat.com/support[support ticket] and the Red{nbsp}Hat team will assist you with next steps.
