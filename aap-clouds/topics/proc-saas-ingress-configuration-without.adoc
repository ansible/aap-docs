...
= Ingress configuration (without AWS PrivateLink)

[role="_abstract"]
For deployments with automation mesh, configuration rely on persistent, load-balanced ingress endpoints that resolve dynamically during a disaster recovery event.
