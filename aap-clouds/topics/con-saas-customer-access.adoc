...
[IMPORTANT]
====
You must change this initial password immediately after your first log in to {PlatformNameShort}.
====
If you need help accessing your deployment, submit a support request through {CustomerSupport}.
