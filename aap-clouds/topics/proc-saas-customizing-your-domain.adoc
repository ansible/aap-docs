...
[role="_abstract"]
To set up a custom domain for your deployment, you must complete the preparatory steps, for domain identification and TLS certificate creation.
This procedure ensures a successful custom URL configuration through Red Hat SRE assistance.
