...
= Subscribe to and Initiate {PlatformNameShort} Deployment in Azure Marketplace.

[role="_abstract"]
Find the {PlatformName} offering in Azure Marketplace, validate and enable your subscription, and initiate the deployment process.
