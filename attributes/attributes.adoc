...
//[Jameria] Note to Aine: I added the Settings menu above because it seems there has been a change in the UI. Now, the following menu selections that used to reside under Settings have now been nested under the Automation Execution selection. So the following need to be updated. Since you have handled these before, I wanted to bring it to your attention in the attribute doc. Going to post a message for you in our #ccs-aap-docs
