...
Metrics are provided by link:https://docs.ansible.com/ansible-tower/latest/html/administration/metrics.html[Ansible], link:https://github.com/containers/prometheus-podman-exporter[Podma] and link:https://cloud.google.com/stackdriver/docs/solutions/agents/ops-agent[Google Ops Agent].
...
include::topics/ref-aap-gcp-ansible-podman-config.adoc[leveloffset=+2]
