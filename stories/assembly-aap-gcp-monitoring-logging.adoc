...
include::topics/con-gcp-pull-container-image.adoc[leveloffset=+1]
include::topics/proc-gcp-generate-variables.adoc[leveloffset=+1]
include::topics/proc-set-monitoring-logging-yaml.adoc[leveloffset=+1]
include::topics/proc-gcp-generate-playbook.adoc[leveloffset=+1]
