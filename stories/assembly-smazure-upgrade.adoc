...
:context: backup
include::topics/con-smazure-upgrade-backup-process.adoc[leveloffset=+1]
:context: upgrade
include::topics/con-smazure-upgrade-upgrading.adoc[leveloffset=+1]
:context: restore
include::topics/con-smazure-upgrade-restore-from-stack.adoc[leveloffset=+1]