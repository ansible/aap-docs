...
For example, to upgrade {PlatformNameShort} to 2.4.20230630, you must be on version 2.3.20230221.

Logging and monitoring must be disabled prior to running the upgrade. 
Follow these link:https://access.redhat.com/documentation/en-us/ansible_on_clouds/2.x/html/red_hat_ansible_automation_platform_from_gcp_marketplace_guide/assembly-gcp-monitoring-logging#con-gcp-setup-after-deployment[instructions] to toggle off monitoring and logging at your current version before beginning the upgrade.
...
.. Follow the link:https://access.redhat.com/documentation/en-us/ansible_on_clouds/2.x/html/red_hat_ansible_automation_platform_from_gcp_marketplace_guide/assembly-aap-gcp-backup-and-recovery#con-gcp-backup-process[Ansible on Clouds 2.3 backup instructions].
...
.. Follow the link:https://access.redhat.com/documentation/en-us/ansible_on_clouds/2.x/html/red_hat_ansible_automation_platform_from_gcp_marketplace_guide/assembly-aap-gcp-backup-and-recovery#con-gcp-restore-process[Ansible on Clouds 2.3 restore instructions].
