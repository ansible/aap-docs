...
= Modifying the CIDR range of the deployment

Why would you want to do this?

If you want to modify your CIDR ranges, you must modify do this before installation.

The default CIDR block is divided into 4 subnets (2 private and 2 public), which have the following CIDR ranges:
...
====
If you want to modify your CIDR ranges, your current deployment must be deleted and the Red Hat {PlatformName} on AWS Cloud Formation template must be updated with your new CIDR ranges.
...
. Update the CIDR blocks of the 4 subnet components.
 (A search for *"AWS::EC2::Subnet"* with quotes should point you to the subnet components in the template.) 
+
[IMPORTANT]
====
