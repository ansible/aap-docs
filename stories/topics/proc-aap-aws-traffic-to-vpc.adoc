...
If you have configured more restrictive outbound rules, then can repeat the previous steps for outbound rules to ensure that your existing VPC can communicate to {AAPonAWS} for UI and API access.
