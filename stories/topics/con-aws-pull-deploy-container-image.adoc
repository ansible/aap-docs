...
For example, if your foundation deployment version is 2.3.20230221, you must pull the operational image with tag 2.3.20230221 to deploy extension nodes to the foundation stack.
