...
For example, if your foundation deployment version is 2.2.20230215, pull the `ansible-on-clouds-ops` image with tag 2.3.20230221 to upgrade to version 2.3.20230221.
=====
+
[source,bash]
----
