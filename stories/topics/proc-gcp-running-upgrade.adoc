...
--env GENERATE_INVENTORY=true  $IMAGE redhat.ansible_on_clouds.gcp_upgrade -e 'gcp_deployment_name=AnsibleAutomationPlatform gcp_service_account_credentials_json_path=/home/runner/.gcp/credentials gcp_compute_region=us-east1 gcp_compute_zone=us-east1-b gcp_backup_taken=True'
===============================================
----
