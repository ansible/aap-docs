...
You must also set up an account with {GCP} (GCP).
...
For more information about {AWS} and terminology, see the link:https://cloud.google.com//[GCP product documentation].
