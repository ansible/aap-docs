...
= Running the ansible-on-clouds-ops 2.4 container to upgrade your {PlatformNameShort} deployment
...
ok: [localhost] => {
    "msg": "Successfully upgraded from '2.3.20230221-00' -> '2.4.xxxxxxxx-00'."
}
----
