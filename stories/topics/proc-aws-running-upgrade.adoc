...
[NOTE]
=====
{PlatformNameShort} upgrade to 2.4.20230630 will update the listeners on its internal load balancers. If a resource dependancy was added after installation, this will need to be temporarily removed to allow the upgrade to succeed. See xref:tech-note-aws-upgrade[technical note] for more detail.
=====
