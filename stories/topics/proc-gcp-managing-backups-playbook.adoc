...
1. Go to the bucket containing your backup.
2. Delete the directory having for name the name of the backup
3. Delete the file having for name the name of the bakcup with "json" as extension.
4. Go to "Filestore" -> "Backup"
5. Delete the Filestore backup having the name of the backup
