...
+
====
IMPORTANT: All deployments will move from the Azure Kubernetes Service (AKS) *Free tier* to the *Standard tier* as part of infrastructure changes when upgrading to {PlatformNameShort} 2.5.  
====
+
