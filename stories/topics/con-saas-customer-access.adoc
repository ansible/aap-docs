...
During the initial configuration of an Ansible Automation Platform Service on AWS deployment, you receive the URL for your deployment. You can also find this information through the Red{nbsp}Hat Hybrid Cloud Console (HCC).
...
====
If you need help accessing your deployment, submit a support request through Red Hat Customer Portal.
