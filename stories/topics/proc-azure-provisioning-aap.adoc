...
. Store the information that you entered in the form in a secure place. You must provide the _Administrator password_ to access your automation platform.
. Click btn:[Next]
...
. From the *Tags* tab, you can select the resources you'd like to apply a tag to, otherwise the default will apply.
