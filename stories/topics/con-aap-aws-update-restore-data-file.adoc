[id="con-aap-aws-update-restore-data-file"]
...
[NOTE]
====
If provided, the playbook defaults to this value over the vaue of the IAM role referenced in the backup file on S3. For further information, see xref:con-aap-aws-backup-process[Backing up the {PlatformNameShort} deployment]
====
+
