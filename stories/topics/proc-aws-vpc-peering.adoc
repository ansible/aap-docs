...
For additional information on route tables, security groups and other networking components regarding VPC Peering, see the link:https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html[What is VPC peering?].
