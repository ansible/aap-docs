...
-----
. Store the service principal details securely, as they are displayed only when you create the secret. You need them when you deploy Automation controller.
See link:{LinkControllerAdminGuide} for help with deploying your automation controller.
