...
[NOTE]
=====
{AAPonGCP} supports sequential upgrades. All upgrades should be no more than one major versions behind what you are currently upgrading to. For example, in order to upgrade to {AAPonGCP} to 2.2.1, you must be on first version of {AAPonGCP}.
=====
