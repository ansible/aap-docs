...
To lauch your offer on the Google Cloud Console, navigate to the marketplace and search for *Red Hat Ansible Automation Platform 2 - Up to 100 Managed Nodes*. After selecting this offer click btn:[Launch].
