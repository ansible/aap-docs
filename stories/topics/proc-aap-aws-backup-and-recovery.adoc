...
[NOTE]
=====  
Operational image tag should match with the version of your foundation deployment. For example, if your foundation deployment version is 2.2.20230215-00, pull the operational image with tag 2.2.20230215-00.
=====
...
[NOTE]
====
If you have a specific RDS snapshot you want to use, you will have to manually find its ARN in the AWS console. You must also ensure the RDS snapshot is a from a AoC deployment with a version matching the version of the operational container you are using to run the restore operation.
==== 
...
[NOTE]
==== 
If you have automatic backups set up and you have a specific EFS recovery point you want to use, you will have to manually find its ARN in the AWS console. You must also ensure the EFS recovery point is a from a AoC deployment with a version matching the version of the operational container you are using the run the restore operation.
====
