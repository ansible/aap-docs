...
[NOTE]
====
{PlatformNameShort} from {Market} is driven using three m5.large instances, two of which run {PlatformNameMain} and{ControllerName} and one which runs {HubName}. 
