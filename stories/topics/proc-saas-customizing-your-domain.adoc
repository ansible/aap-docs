...
.. From the {PlatformNameShort} navigation panel, select *Settings*.
.. Select menu:Automation Execution[System].
.. On the *System Settings* page,  click btn:[Edit] and update the *Base URL of the service*.
.. Click btn:[Save] to apply the custom domain to your deployment. 
+
