...
// [gmurray] Moving to section 5.4.4 Microsoft Entra ID SSO configuration as a subsection no longer it's own module. Keeping for now in case we roll back but can delete post 2.5 release for Azure etc: feb '25
