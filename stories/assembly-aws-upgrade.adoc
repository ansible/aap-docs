...
It is required to create a backup before running the upgrade.
...
For example, to upgrade {PlatformNameShort} to 2.4.xxxxxxxx, you must be on version 2.3.20230221.
=====
...
.. Follow the link:https://access.redhat.com/documentation/en-us/ansible_on_clouds/2.x/html/red_hat_ansible_automation_platform_from_aws_marketplace_guide/assembly-aws-backup-and-restore#con-aws-backup-process[Ansible on Clouds 2.3 backup instructions]
...
.. Begin upgrading {PlatformNameShort}

. (Optional) Restore the stack from a backup. 
.. Follow the link:https://access.redhat.com/documentation/en-us/ansible_on_clouds/2.x/html/red_hat_ansible_automation_platform_from_aws_marketplace_guide/assembly-aws-backup-and-restore#con-aws-restore-process[Ansible on Clouds 2.3 restore instructions].
