...
[NOTE]
====
For more information about recent upgrades to {AutomationDashboardName}, see link:https://access.redhat.com/articles/7136888[What’s new: Upgrades for {AutomationDashboardName}].
====
