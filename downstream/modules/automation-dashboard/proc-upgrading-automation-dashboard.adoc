...
[role="_abstract"]
This procedure applies when upgrading from {AutomationDashboardName} versions before 0.2 (which did not include Redis) to the current version. This process involves running the installation program and updating your cluster configuration with new authentication requirements.

[NOTE]
====
For more information about recent updates to {AutomationDashboardName}, see link:https://access.redhat.com/articles/7136888[What’s new: Upgrades for {AutomationDashboardName}].
====
