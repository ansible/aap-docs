...
+
** When the `configuration_version_id` is unspecified, {TerraformEnterpriseShortName} or {TerraformCloudShortName} picks the latest approved `configuration_version_id` in the workspace.
