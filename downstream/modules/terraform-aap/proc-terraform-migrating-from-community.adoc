...
If you want to use {PlatformNameShort} with {TerraformEnterpriseShortName} (TFE) or {TerraformCloudShortName} and you are currently using {TerraformCommunityName} (TCE), you must migrate to TFE or {TerraformCloudShortName} and then update {PlatformNameShort} configurations to work with TFE or {TerraformCloudShortName}.

When you migrate from TCE to TFE or {TerraformCloudShortName}, you are not migrating the collection itself. Instead, you are adapting your existing TCE usage to work with TFE or {TerraformCloudShortName}. 

After you migrate, you must update the {PlatformNameShort} credentials, execution environment, and job templates.
