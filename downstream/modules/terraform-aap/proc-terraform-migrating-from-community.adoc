...
.. link:{URLHashiGuide}/terraform-product#terraform-creating-credential[Create a credential].
.. link:{URLHashiGuide}/terraform-product#terraform-building-execution-environment[Build an {ExecEnvShort} in {PlatformNameShort}].
.. link:{URLHashiGuide}/terraform-product#terraform-creating-launching-job-template[Create and launch a job template].
