...
You can create a new group in {PlatformNameShort} designed to support content curation in your organization. This group can contribute internally-developed collections for publication in {PrivateHubName}.
...
* You have administrative permissions in {PlatformNameShort} and can create groups.
