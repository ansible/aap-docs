...
= Import automation content to {HubName}

[role="_abstract"]
As an automation content creator, you can import a collection to your custom repository. 

To use a collection in your custom repository, first import the collection into your namespace so the {HubName} administrator can approve it.
