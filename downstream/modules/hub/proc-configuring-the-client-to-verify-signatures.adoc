...
= Configure the client to verify signatures

[role="_abstract"]
To ensure an {ExecEnvShort} pulled from the remote registry is properly signed, first configure the {ExecEnvShort} with the proper public key in a policy file. 
...
* link:https://github.com/containers/image/blob/main/docs/containers-policy.json.5.md#signedby[Documentation for containers-policy.json] 