...
. To sync the content from a remote repository into this repository, in the *Remote* field select the remote that contains the collections you want included in your custom repository.
. Click btn:[Create repository].
