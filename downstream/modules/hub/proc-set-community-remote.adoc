...
= Configure the {PrivateHubName} community repository

[role="_abstract"]
Configure the *community* remote repository to synchronize chosen collections from {Galaxy} to your {PrivateHubName}.
