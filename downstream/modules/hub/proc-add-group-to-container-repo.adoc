...
= Provide access to your execution environments

[role="_abstract"]
Provide users with access to your {ExecEnvName} by adding them to a team. 

After you've added users to a team, modify the permissions the team can have to a particular {ExecEnvShort}.
