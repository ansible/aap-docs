...
For more information about using requirements files, see link:{URLHubManagingContent}/managing-collections-hub#repository-sync[Creating a requirements file].
