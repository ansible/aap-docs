...
= Browsing the collection catalog

[role="_abstract"]
Browse the collection catalog to find and explore Ansible collections in {SelfServiceShort}.
The catalog displays collections discovered from your synchronized repositories and execution environment definitions, showing collection metadata, dependencies, and documentation links.
