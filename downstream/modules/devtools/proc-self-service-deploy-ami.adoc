...
Use this procedure to configure the {PlatformNameShort} (AAP) authentication, prepare the AWS environment, and deploy the Amazon Machine Image (AMI).
...
** Navigate to *Access Management > Organizations* and click *Add*.
** Enter a unique *Name* (for example, `portal-<yourname>-org`) and click *Save*.
** Navigate to *Access Management > OAuth Applications* and click *Create OAuth application*.
...
** Navigate to *Access Management > Users* and click the *admin* user.
