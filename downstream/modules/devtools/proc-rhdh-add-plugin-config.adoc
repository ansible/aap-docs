...
global:
  ...
  # NEW: Specify the Ansible Plug-in version (Matches the AAP version, e.g., 2.6)
  imageTagInfo: "2.6"
...
+
-----
=> Successfully installed dynamic plugin oci:registry.redhat.io/ansible-automation-platform/automation-portal:2.6
-----
+
