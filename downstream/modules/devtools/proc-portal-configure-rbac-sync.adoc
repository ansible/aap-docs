...
You can only select {PlatformNameShort} teams and users from the {PlatformNameShort} Organization that you have configured for synchronization with {SelfServiceShort}.
====
...
* link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/access_management_and_authentication/gw-token-based-authentication#gw-oauth2-security-controls[Ansible Automation Platform token best practices]
