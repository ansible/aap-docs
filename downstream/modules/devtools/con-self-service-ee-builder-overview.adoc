...
= Understanding the Execution Environment Builder

[role="_abstract"]
The Execution Environment (EE) Builder in {SelfServiceShort} enables you to create custom execution environment definitions through a guided UI wizard or backend configuration methods.
