...
= Create a project in the {RHDH} UI
...
* You have the correct access (RBAC) to view the templates in {RHDH}. Ask your administrator to assign access to you if necessary.
...
//For more information, see the link:https://docs.ansible.com/projects/ansible/latest/dev_guide/developing_modules_in_groups.html#naming-conventions[Ansible Collection naming conventions documentation].
====
. Click *Review*.
