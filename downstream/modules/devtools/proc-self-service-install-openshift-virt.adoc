...
Deploy the {SelfService} appliance on OpenShift Virtualization to run virtual machine workloads alongside container workloads within your OpenShift Container Platform cluster.
