...
[NOTE]
====
Red Hat provides a link:https://github.com/ansible/ansible-rhdh-templates/[repository of software templates for {RHDHShort}] that uses the `publish:github` action.
