...
+
----
ansible-navigator run site.yml --eei ee-minimal-{RHELURLVers}
----
...
* link:{URLNavigatorGuide}/assembly-execute-playbooks-navigator_installing-devtools[Running Ansible playbooks with {Navigator}]
