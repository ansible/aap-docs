...
link:{URLSelfServiceInstall}/self-service-disconnected-install_aap-self-service-install[Installing the Ansible automation portal in an air-gapped environment] section of _{LinkSelfServiceInstall}_.
====
...
.. Open your OpenShift Project that has your {SelfServiceShort} installation.
...
.. Ensure you are in the OpenShift Project that has your {SelfServiceShort} Helm deployment.
