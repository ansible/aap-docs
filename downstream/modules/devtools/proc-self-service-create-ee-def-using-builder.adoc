...
* You have reviewed the link:{URLSelfServiceUsing}/self-service-create-ee-definitions_aap-self-service-using#self-service-planning-reference-ee-definitions_self-service-create-ee-definitions[Planning and reference for EE definitions section].
