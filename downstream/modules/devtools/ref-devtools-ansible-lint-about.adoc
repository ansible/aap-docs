...
The goal of {LintName} is to flag syntax and programming errors, bugs, stylistic errors, and suspicious constructs.
...
* For information about rules in {LintName}, see xref:devtools-ansible-lint-rules_[text]
