...
Collections are discovered during repository synchronization when {SelfServiceShort} processes Backstage catalog entity files and {ExecEnvShort} definitions.
...
* Identify which {ExecEnvShort}s include specific collections
