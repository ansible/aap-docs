...
[role="_abstract"]
Scaffold a collection using the Ansible extension in {VSCode}. This process creates the necessary directory structure for packaging and distributing your roles and plug-ins.
