...
The `python` entry in the definition file points to a valid requirements file or or to an inline list of Python requirements in PEP508 format for the `pip install -r ...` command.
