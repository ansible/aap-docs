...
[role="_abstract"]
The `python` entry in the definition file points to a valid requirements file or to an inline list of Python requirements in link:https://docs.ansible.com/projects/builder/en/latest/porting_guides/porting_guide_v3.1/#pep-508-standard[PEP508] format for the `pip install -r ...` command.
