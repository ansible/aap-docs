...
The installation process often requires an hour or more to complete, and this control can kill the installation process and log out the user before installation is complete. 
