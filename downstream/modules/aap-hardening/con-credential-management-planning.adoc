...
{PlatformNameShort} manages three sets of secrets:
...
You can further secure automation credentials by ensuring they are unique and stored only in {PlatformNameShort} or in a supported external secrets management system. 
