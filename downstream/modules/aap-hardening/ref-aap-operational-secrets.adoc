...
| `/etc/ansible-automation-platform/eda/server.cert` .2+| SSL certificate and key for the {EDAName} controller web service. 
...
| `/etc/ansible-automation-platform/eda/cache.cert` .2+| SSL certificate and key used for mutual TLS (mTLS) authentication with the Redis cache used by the {EDAName} controller

| `/etc/ansible-automation-platform/eda/cache.key` 

| `/etc/ansible-automation-platform/eda/websocket.cert` .2+|SSL certificate and key for the {EDAName} controller websocket endpoint. 
