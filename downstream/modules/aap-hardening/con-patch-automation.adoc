...
Manual patching of similar systems could result in human error (forgetting one or more patches, patching using different versions) that impacts consistency.
