...
These public keys must correspond with the private keys utilized for establishing Machine credentials in {PlatformNameShort}, as these credentials facilitate connections to the RHEL managed nodes.
