...
Where an existing PKI infrastructure is available, generate certificates for the {ControllerName}, {PrivateHubName}, {EDAcontroller}, and the PostgreSQL database server. 
