...
Although PostgreSQL database can also be installed as part of the {PlatformNameShort} deployment, you are recommended to use a user-provided PostgreSQL database.
