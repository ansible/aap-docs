...
{PlatformNameShort}'s built-in logging and activity stream support {PlatformName} logs all change within {PlatformName} and automation logs for auditing purposes. 
