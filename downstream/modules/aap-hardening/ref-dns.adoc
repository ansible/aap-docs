...
All {PlatformNameShort} infrastructure nodes must have a valid FQDN defined in DNS which resolves to a routable IP address. These FQDNs are used in the {Installer} inventory file.