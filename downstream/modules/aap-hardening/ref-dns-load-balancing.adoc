...
When using a load balancer with {PlatformNameShort} as described in the enterprise deployment topology, an additional FQDN is needed for the load-balancer.
