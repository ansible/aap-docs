...
[role="_abstract"]
Restrict remote login access to connections originating from the {PlatformNameShort} {ControllerName} and execution nodes to ensure the service account is exclusively used by {PlatformNameShort}.
