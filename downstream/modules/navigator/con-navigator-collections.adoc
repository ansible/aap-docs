...
[role="_abstract"]
Understand the information displayed by {NavigatorStart} about your collections, such as shadowing, type, and path. This overview helps you verify the collection source and search priority.
