...
= Create an {Navigator} settings file

[role="_abstract"]
Alter default {Navigator} settings using the command line, environment variables, or a dedicated settings file. Using a settings file helps ensure consistent configuration across sessions.
