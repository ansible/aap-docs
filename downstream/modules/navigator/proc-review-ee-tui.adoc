...
= Review {ExecEnvName} from {Navigator}

[role="_abstract"]
Use the {Navigator} text-based interface to review your {ExecEnvName}. This allows you to quickly inspect packages, versions, and collections installed in the environment.
