...
= Browse collections from {Navigator}
...
// 
// * https://docs.ansible.com/projects/ansible/latest/cli/ansible-collection.html[ansible-collection].
// * https://docs.ansible.com/projects/ansible/latest/user_guide/intro_collection.html[Introduction to Ansible inventories].
