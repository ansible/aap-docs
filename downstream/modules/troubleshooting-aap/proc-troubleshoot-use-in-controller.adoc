...
You cannot use the *Use in Controller* option for an {ExecEnvShort} image on {PrivateHubName}. You also receive the following error message: “No Controllers available”.
...
.Verification
* Verify you can now use the *Use in Controller* option in {PrivateHubName}.
