...
| 2 | {GatewayStart} | `automationgateway` 
...
[NOTE]
====
6 VMs are required for a Redis high availability (HA) compatible deployment. Redis can be colocated on each {PlatformNameShort} component VM.
====
