...
* If you are installing {EDAName} on {OCPShort}, the 12 rulebook activations per node is a global limit for the application since there is no concept of worker or hybrid notes in {OCPShort}.
====
