...
[role="_abstract"]
By default, {EDAcontroller} allows 12 rulebook activations per node (with two worker or hybrid nodes), resulting in a limit of 24 activations in total, to run simultaneously.
