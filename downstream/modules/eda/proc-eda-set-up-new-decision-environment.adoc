...
* You have pushed a decision environment image to an image repository or you chose to use the `de-minimal` image that is provided by `de-supported` options located in the link:http://registry.redhat.io/[registry.redhat.io].
