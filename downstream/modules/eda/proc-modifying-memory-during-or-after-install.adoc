...
[role="_abstract"]
Memory usage is based on the number of events that {EDAcontroller} has to process. By default, each rulebook activation container has a 200 MB memory limit. 
