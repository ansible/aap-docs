...
. Locate and copy the `“id”` of the event stream UUID that you want to update. This can be found at the end of the event 
+
[example]
----
},
...
----
+
. Paste the id at the end of the URL (for example,  https://<platformURL>.com/api/eda/v1/_<id#>_) and press *Enter*. The *Event Stream Instance* page is displayed, including the new “uuid” value. 
...
.Verification
*Check the UUID of your updated or newly created event stream to confirm that the UUID has been updated.