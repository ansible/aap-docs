...
** If you want to connect {EDAcontroller} to {PlatformNameShort} 2.4, you must use link:hhttp://registry.redhat.io/ansible-automation-platform-24/de-supported-rhel8:latest[{PlatformNameShort} 2.4 supported decision environment]
** If you want to connect {EDAcontroller} to {PlatformNameShort} {PlatformVers}, you must use link:http://registry.redhat.io/ansible-automation-platform-25/de-supported-rhel8:latest[{PlatformNameShort} {PlatformVers} supported execution environment]
====
