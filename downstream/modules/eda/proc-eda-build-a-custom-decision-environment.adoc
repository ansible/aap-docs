...
* If you want to connect Event-Driven Ansible controller to AAP 2.5, you must use `registry.redhat.io/ansible-automation-platform-25/de-supported-rhel8:latest`.
====
