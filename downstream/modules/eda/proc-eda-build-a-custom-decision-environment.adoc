...
[IMPORTANT] 
====
The `ansible.eda` collection requires specific system dependencies (`libsystemd0`, `libsystemd-dev`, and `pkg-config`) to function correctly. You must include them in your decision environment build as shown in the following examples.
====
+
