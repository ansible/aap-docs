...
{Vault} lets you centrally store and manage secrets securely. The {PlatformNameShort} certified `hashicorp.vault` collection provides fully automated lifecycle and operation management for {Vault}. You can create, update, and delete secrets through playbooks.
