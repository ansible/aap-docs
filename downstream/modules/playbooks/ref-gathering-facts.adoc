...
//You can store these facts and use them directly in another task, such as with the link:https://docs.ansible.com/projects/ansible/latest/collections/arista/eos/eos_interfaces_module.html#ansible-collections-arista-eos-eos-interfaces-module[`eos_interfaces`] resource module.
