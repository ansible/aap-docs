...
= Scaling and management considerations by installation type

[role="_abstract"]
Considerations for scaling and managing each {PlatformNameShort} component differ based on the installation type.
The following table provides information on scaling and management operations for each installation type, and other common operations to consider when planning your deployment:
...
|Ansible Playbook-based installation program installs RPMs and configures the platform.
...
|Requires running the installation program and restarting services, which halts use of the platform.
|Requires running the installation program and restarting services, which halts use of the platform.
