...
= Scale the {Gateway} proxy and authentication service

[role="_abstract"]
Scaling the {Gateway} proxy and authentication service might be appropriate if the volume of requests to proxy or authenticate exceeds existing {Gateway} service capabilities.
