...
= Scale the {ControllerName} API service
...
Provisioning additional control nodes demands more database connections than scaling out the web deployment on {OCPShort} alone.
