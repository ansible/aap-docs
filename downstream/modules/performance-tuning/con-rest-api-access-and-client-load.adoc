...
You can access this API by using various clients, including cURL, Python, {PlatformNameShort} configuration collections, or the Ansible URI module.
...
Token authentication is recommended for better performance.
