...
When a service's API pod shows consistently high CPU usage, it might be unable to process incoming requests in a timely manner, leading to a backlog of requests.
