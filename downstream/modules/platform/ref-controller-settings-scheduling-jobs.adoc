...
The task manager periodically collects tasks that must be scheduled and determines which instances have capacity and are eligible for running them. The task manager has the following workflow:
