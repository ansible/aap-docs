...
For more information, see link:https://docs.ansible.com/automation-controller/4.4/html/administration/oauth2_token_auth.html#ag-oauth2-token-auth-grant-types[Application Functions] in the Applications section of the _Automation Controller Administration Guide_.
