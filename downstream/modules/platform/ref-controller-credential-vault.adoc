...
// For more information about the Multi-Vault support, see the link:https://legacy-controller-docs.ansible.com/automation-controller/latest/html/administration/multi-creds-assignment.html#multi-vault-credentials[Multi-Vault Credentials] section of _{ControllerAG}_.
...
//For more information about Ansible Vault, see link:http://docs.ansible.com/projects/ansible/playbooks_vault.html[Protecting sensitive data with Ansible vault].
