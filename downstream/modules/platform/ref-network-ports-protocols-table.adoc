...
* Where the Port listed is 80/443, port 80 is only used if you set `nginx_disable_https`, `automationhub_disable_https` or `automationedacontroller_disable_https` to `true`. See link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.4/html-single/red_hat_ansible_automation_platform_hardening_guide/index#ref-security-variables-install-inventory_hardening-aap[Security-relevant variables in the installation inventory]
====
