...
No, {ControllerName}, {HubName}, and {EDAName} are nested within the deployment and will be deleted also.

Something went wrong with my deployment but I'm now sure what, how can I find out?::
