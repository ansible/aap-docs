...
You can use RBAC controls to enable {ContollerName} to increase security and streamline management.
...
You should become familiar with some main concepts of {ControllerName}'s RBAC design roles, resources, and users: 
...
Users receive capabilities only through the roles to which they are assigned or hrough roles they inherit through the role hierarchy. 
