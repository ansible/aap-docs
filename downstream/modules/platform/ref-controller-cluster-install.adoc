...
[role="_abstract"]
Learn how to install and configure a {ControllerName} cluster installation.
...
If you are upgrading from an earlier version of the platform, and you specified `rabbitmq_host` in your inventory, rename `rabbitmq_host` to `routable_hostname` before upgrading.
====
