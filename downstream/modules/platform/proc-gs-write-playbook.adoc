...
* For more information on playbooks, see link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/getting_started_with_ansible_playbooks/index#ref-playbook-execution[Getting Started with Ansible Playbooks].
