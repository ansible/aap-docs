...
[role="_abstract"]
{AutomationMeshStart} makes use of unique node types to create both the *control* and *execution* plane. Learn more about the control and execution plane and their node types before designing your {MeshName} topology.
