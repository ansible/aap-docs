...
For further information, see link:{LinkOperatorMesh}/assembly-automation-mesh-operator-aap#proc-define-mesh-node-types[Defining {AutomationMesh} node types]
endif::operator-mesh[]