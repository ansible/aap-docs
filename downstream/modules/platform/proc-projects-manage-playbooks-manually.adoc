...
[role="_abstract"]
Manage Ansible playbooks and directories directly on the {ControllerName} filesystem. 
This approach helps ensure proper file ownership and permissions when you cannot use source control.
