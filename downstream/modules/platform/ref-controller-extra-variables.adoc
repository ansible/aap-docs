...
[role="_abstract"]
You can pass extra variables to a job template in {ControllerName} in several ways, including through surveys and the API.
...
//For more information about unsafe variables, see link:https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_advanced_syntax.html#unsafe-or-raw-strings[Unsafe or raw strings]. 
