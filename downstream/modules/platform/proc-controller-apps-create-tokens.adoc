...
link:https://docs.ansible.com/automation-controller/4.4/html/administration/tower-manage.html#ag-token-utility[Token and session management] section of the _Automation Controller Administration Guide_
====
