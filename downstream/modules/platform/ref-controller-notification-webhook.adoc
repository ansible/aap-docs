...
* *Disable SSL Verification*: SSL/TLS verification is on by default, but you can choose to turn off verification of the authenticity of the target's certificate. 
