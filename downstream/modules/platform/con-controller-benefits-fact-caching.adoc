...
//To clear facts, run the Ansible `clear_facts` link:https://docs.ansible.com/projects/ansible/latest/collections/ansible/builtin/meta_module.html#examples[meta task].
