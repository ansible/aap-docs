...
[id="proc-gw-add-team-organization_{context}"]
...
To add roles for a team, the role must already exist. See xref:proc-gw-roles_auto-exec[Automation execution roles] and xref:proc-gw-roles_auto-dec[Automation decision roles] for more information about creating new roles.
