...
* Only applicable to Smart Inventories: *Smart Host Filter*: Click the image:searchpng[Search,15,15] icon to open a separate window to filter hosts for this inventory. 
...
[Control where a job runs] in the _Automation Controller Administration Guide_. 
...
:context: inventory
include::proc-controller-adding-permissions.adoc[leveloffset=+1]
:!context: inventory
