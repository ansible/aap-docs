...
link:https://docs.ansible.com/automation-controller/4.4/html/administration/containers_instance_groups.html#ag-instance-groups-control-where-job-runs[Control where a job runs] in the _Automation Controller Administration Guide_. 
...
include::proc-controller-adding-inv-permissions.adoc[leveloffset=+1]
include::proc-controller-add-groups.adoc[leveloffset=+1]
include::proc-controller-add-hosts.adoc[leveloffset=+1]
include::proc-controller-add-source.adoc[leveloffset=+1]
include::ref-controller-view-completed-jobs.adoc[leveloffset=+1]
