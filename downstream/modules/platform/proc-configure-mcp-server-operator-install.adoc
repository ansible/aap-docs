...
As an organization administrator, you can deploy and configure an Ansible MCP server on the {OperatorBase} of {PlatformNameShort} {PlatformVers}.

Use the following procedure to deploy and configure the Ansible MCP server on an {OperatorBase} of {PlatformNameShort} {PlatformVers}.
