...
. Create a file named `/home/my-user/cron-gather` (replace `/home/my-user/` with your required path) and add the following content to create the `cron-gather` script:
+
----
#!/bin/sh
...
. Create a file named `/home/my-user/cron-report` (replace `/home/my-user/` with your required path) and add the following content to create the `cron-report` script:
+
----
#!/bin/sh
