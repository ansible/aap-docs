...
| Instance Groups | Choose link:{URLControllerUserGuide}/assembly-controller-topology-viewer[Instance and Container Groups] to associate with this job template.
