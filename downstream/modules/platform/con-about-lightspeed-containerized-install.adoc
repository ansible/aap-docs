...
+
If the Red Hat AI Inference Server deployment is in a different environment than the {LightspeedShortName} deployment, ensure the model deployment allows access using a secure connection and configure appropriate network routing.
+
