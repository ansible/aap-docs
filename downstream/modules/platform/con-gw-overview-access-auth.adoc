...
The first time you log in to the {PlatformNameShort}, you must enter your subscription information to activate the platform. For more information about licensing and subscriptions, see _Managing {PlatformNameShort} licensing, updates and support_ in the link:{URLInstallationGuide}/assembly-platform-install-overview#assembly-gateway-licensing[{TitleInstallationGuide}], link:{URLContainerizedInstall}/assembly-gateway-licensing[{TitleContainerizedInstall}], or link:{URLOperatorInstallation}/assembly-gateway-licensing-operator-copy[{TitleOperatorInstallation}] guide. 
