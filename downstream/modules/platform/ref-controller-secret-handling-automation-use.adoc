...
To encrypt secret fields, {ControllerName} uses AES in CBC mode with a 256-bit key for encryption, PKCS7 padding, and HMAC by using SHA256 for authentication. 
