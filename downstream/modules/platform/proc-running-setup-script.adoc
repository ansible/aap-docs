...
[role="_abstract"]
Run the {Installer} setup script after updating the inventory file with all required parameters to begin the installation and configuration of the platform.
