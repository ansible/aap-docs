...
ifdef::mesh-VM[]
If you want to add additional execution nodes to your automation mesh after the initial setup, edit the inventory file to add the new node, then rerun the `setup.sh` script.
endif::mesh-VM[]