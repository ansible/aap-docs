...
You can find sample inventory files in the link:https://github.com/ansible/test-topologies/[Test topologies] GitHub repository, or in our link:{LinkTopologies} guide.
