...
[role="_abstract"]
You can upgrade your 2.4 single node {ControllerName} and {HubName} deployment to a {PlatformVers} {GrowthTopology}. This section outlines the infrastructure changes, requirements, and an example inventory for upgrading.
