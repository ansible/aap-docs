...
* PackageKit can frequently interfere with the installation/update mechanism. Consider disabling or removing PackageKit if installed before running the setup process.
