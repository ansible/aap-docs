...
= Creating an API token for the Ansible MCP server 
...
.Procedure
. From the navigation panel, select menu:Access Management[Users].
...
. From the navigation panel, select menu:Access Management[OAuth Applications].
