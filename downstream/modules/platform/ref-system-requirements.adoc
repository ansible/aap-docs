...
h| OS | {RHEL} 8.8 or later (x86_64, aarch64), or {RHEL} 9.2 or later (x86_64, aarch64) |{PlatformName} is also supported on OpenShift, see link:{LinkOperatorInstallation} for more information.
