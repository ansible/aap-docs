...
To have the installer automatically pick up and apply your AAP subscription manifest license, then use this guide to generate a manifest file which can be downloaded for the installer: link:https://access.redhat.com/documentation/en-us/red_hat_ansible_automation_platform/2.4/html/red_hat_ansible_automation_platform_operations_guide/assembly-aap-obtain-manifest-files[Chapter 2. Obtaining a manifest file Red Hat Ansible Automation Platform 2.].