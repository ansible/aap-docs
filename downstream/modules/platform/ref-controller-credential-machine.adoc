...
//Removing this note at AAP-63419 as Ansible 2.8 is ancient
//[NOTE]
//====
//Custom `become` plugins are available from Ansible 2.8+.
//Commenting out as no downstream alternative [AAP-57435]
//For more information, see link:https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_privilege_escalation.html[Understanding Privilege Escalation] and the list of link:https://docs.ansible.com/projects/ansible/latest/plugins/become.html#plugin-list[Become plugins]
//====
