...
* Optional: *Organization*: Enter the name of the organization with which the credential is associated, or click the search image:search.png[Search,10,10] icon and select it from the *Select organization* window.
