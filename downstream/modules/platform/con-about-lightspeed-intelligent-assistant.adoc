...
. xref:proc-install-operator-chatbot_deploying-chatbot-operator[Install] and xref:proc-configure-operator-chatbot_deploying-chatbot-operator[configure] the {PlatformNameShort} operator.
