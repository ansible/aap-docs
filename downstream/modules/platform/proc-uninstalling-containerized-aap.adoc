...
When performing a reinstall following an uninstall that preserves the databases, it is necessary to use the previously generated {PlatformNameShort} secret key values to access the preserved databases.
