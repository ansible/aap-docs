...
[role="_abstract"]
The following procedure describes how to change the SSL/TLS certificate and key for your operator-based {PlatformNameShort} installation of {ControllerName} running on {OCPShort}.
