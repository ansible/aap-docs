...
[role="_abstract"]
You can upgrade your 2.4 RPM-based, multi-node {ControllerName} and {HubName} deployment to a {PlatformVers} {EnterpriseTopology}. This section outlines the infrastructure changes, requirements, and an example inventory for upgrading.
