...
//For more information about these variables, see link:https://docs.ansible.com/projects/ansible/latest/collections/openstack/cloud/openstack_inventory.html[openstack inventory plugin].
//+
