...
For more information, see link:https://www.redhat.com/en/blog/satellite-and-ansible-tower-integration-part-2-provisioning-callbacks[Provisioning Callbacks].
