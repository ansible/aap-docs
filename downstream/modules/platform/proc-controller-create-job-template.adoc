...
For guidance on using multiple credential types together, such as Machine and Network credentials, see                                                    xref:assembly-multi-credential-assignment[Multi-credential assignment].
