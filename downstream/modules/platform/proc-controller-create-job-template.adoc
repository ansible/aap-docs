...
This is the "-e" or "-extra-vars" command line parameter for ansible-playbook that is documented in the Ansible documentation at xref:controller-extra-variables[Extra variables].
