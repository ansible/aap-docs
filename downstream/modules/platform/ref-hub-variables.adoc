...
Values available `TLSv1.2`, `TLSv1.3`

If `nginx_tls-protocols` is set to `TLSv1.3` only TLSv1.3  is enabled.
To set both protocols use `nginx_tls_protocols`=[`TLSv1.2, TLSv.1.3`]
