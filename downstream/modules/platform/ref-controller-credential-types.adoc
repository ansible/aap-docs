...
* link:{URLControllerUserGuide}/controller-credentials#ref-controller-credential-insights[{RHLightspeed}]
...
//[Jonquil] HCP Terraform credential type applies to 2.6 and later:
* link:{URLControllerUserGuide}/controller-credentials/#ref-controller-credential-terraform-hcp[Terraform: HCP Terraform credential type]
