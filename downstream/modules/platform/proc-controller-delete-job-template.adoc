...
* Select the required job template, on the *Details* page click the {MoreActionsIcon}  icon and select and select image:delete-button.png[Delete template,15,15] btn:[Delete template].
