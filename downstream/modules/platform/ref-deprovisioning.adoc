...
[role="_abstract"]
You can deprovision nodes and instance groups by using the {PlatformNameShort} installation program.
Running the installation program will remove all configuration files and logs attached to the nodes in the group.
