...
You can limit users who can login to the platform by limiting only those in an organization or on a team within an organization.
...
. Select *GitHub organization* from the *Authentication type* list.
