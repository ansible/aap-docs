...
* link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/{PlatformVers}/html/rpm_installation/assembly-platform-install-overview#proc-attaching-subscriptions[Attaching your {PlatformName} subscription]
* link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/{PlatformVers}/html/rpm_upgrade/controller-backup-and-restore[Backup and restore {PlatformName}]
