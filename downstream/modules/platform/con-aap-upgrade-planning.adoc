...
====
* Back up your {PlatformNameShort} environment before upgrading in case any issues occur. See link:{URLUpgrade}/controller-backup-and-restore#backup-using-automation-installer[Back up the platform using automation installer]. and {LinkOperatorBackup} for the specific topology of the environment.
