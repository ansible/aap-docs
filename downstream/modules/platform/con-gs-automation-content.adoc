...
In {HubName} you can also find content collections that you can download and integrate into your automation environment. You can also create an upload your own content to distribute to your users.
...
For more information about Ansible content, see xref:tbd[Create automation content] in xref:tbd{Getting started as an automation developer}.
