...
[role="_abstract"]
The {RHLightspeed} playbook contains a `hosts:` line where the value is the host name supplied to {RHLightspeed}, which can be different from the host name supplied to {ControllerName}.
