...
See the link:{BaseURL}/documentation/red_hat_ansible_automation_platform/{PlatformVers}/html-single/installing_on_openshift_container_platform/index#operator-channel-upgrade_operator-upgrade[Channel Upgrades] section for more information.
