...
[role="_abstract"]
Centrify Vault Credential Provider Lookup enables {ControllerName} to retrieve secrets from Centrify Vault when executing jobs. 
This integration uses the Centrify Vault API to look up secrets at job runtime.
