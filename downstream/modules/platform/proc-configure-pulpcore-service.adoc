...
[role="_abstract"]
After you have configured the inventory file and applied the SELinux context, configure the pulp service.This ensures that {HubName} services start only after starting the network and mounting the remote mount points.
