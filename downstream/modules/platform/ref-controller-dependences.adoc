[id="ref_controller-dependencies"]
...
Only requirements with _no_ profiles (runtime requirements) are installed to the image. 
...
It also removes any Python requirements that are normally be excluded (see *python* dependencies).
