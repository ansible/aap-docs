...
[NOTE]
====
If a field has the *Prompt on launch* checkbox selected, either aunching the workflow template, or using the workflow template within another workflow template, you are prompted for the value for that field.
...
For more information, see the [Workflow visualizer] section of the _Automation Controller Administration Guide_.
