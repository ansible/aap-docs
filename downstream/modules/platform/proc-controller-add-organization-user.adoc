...
====
+
. To remove a particular user from the organization, select *Remove user* from the {MoreActionsIcon} list next to the user. This launches a confirmation dialog, asking you to confirm the removal.
