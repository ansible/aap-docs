...
Constructed inventories make use of the link:https://docs.ansible.com/ansible/latest/collections/ansible/builtin/constructed_inventory.html#ansible-builtin-constructed-inventory-uses-jinja2-to-construct-vars-and-groups-based-on-existing-inventory[ansible.builtin.constructed inventory] model.
...
include::ref-controller-group-name-vars-filtering.adoc[leveloffset=+1]
include::ref_controller-inv-debugging-tips.adoc[leveloffset=+1]
include::ref-controller-inv-nested-groups.adoc[leveloffset=+1]
include::ref-controller-inv-ansible-facts.adoc[leveloffset=+1]
