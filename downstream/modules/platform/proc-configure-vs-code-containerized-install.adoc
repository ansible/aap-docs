...
* Your network or firewall configuration permits ingress traffic on port 8447. This port is required for containerized installations to connect {ibmwatsonxcodeassistant} with the Ansible VS Code extension, which provides access to the Ansible Lightspeed coding assistant.
