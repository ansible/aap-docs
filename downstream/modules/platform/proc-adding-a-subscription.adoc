...
* Obtain your manifest file. See link:{URLContainerizedInstall}/assembly-gateway-licensing#assembly-aap-obtain-manifest-files[Obtaining a manifest file] for more information.
...
. Select your subscription and click btn:[Next].
