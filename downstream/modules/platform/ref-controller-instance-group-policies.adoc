...
It guarantees that this percentage of active {ControllerName} instances will be added to this instance group. 
...
The *Instance Groups* list view from the {ControllerName} user interface provides a summary of the capacity levels for each instance group according to instance group policies:

image::ug-instance-groups_list_view[Instance Groups list view]
