...
//These can be defined by the `set_stats` link:https://docs.ansible.com/projects/ansible/latest/collections/ansible/builtin/set_stats_module.html[Ansible module].
