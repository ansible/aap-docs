...
For more information, see link:{BaseURL}red_hat_ansible_automation_platform/{PlatfomVers}/html-single/access_management_and_authentication/index#proc-controller-create-organization[Creating an organization]. 
