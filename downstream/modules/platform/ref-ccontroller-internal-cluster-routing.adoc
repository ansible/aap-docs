[id="ref-ccontroller-internal-cluster-routing"]

= Internal Cluster Routing

The {ControllerName} cluster hosts communicate across the network within the cluster. 
In the inventory file for the traditional VM installer, multiple routes are indicated to the cluster nodes that will be used in different ways:
