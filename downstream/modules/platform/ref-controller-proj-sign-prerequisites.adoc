...
= Controller project sign prerequisites

[role="_abstract"]
Prepare your {RHEL} systems by enabling the correct repositories and subscriptions needed to install components for project signing. 
This step helps ensure that your environment is properly configured for content verification.
...
default keyring. 
In this case, see link:https://www.redhat.com/sysadmin/creating-gpg-keypairs[How to create GPG keypairs] to learn how to create a new keypair before proceeding. 
