...
{PlatformNameShort} {PlatformVers} moves you away from custom Python virtual environments (venvs) in favor of {ExecEnvName} - containerized images that packages the necessary components needed to run and scale your Ansible automation. This includes Ansible Core, Ansible Content Collections, Python dependencies, {RHEL} UBI 8, and any additional package dependencies.
