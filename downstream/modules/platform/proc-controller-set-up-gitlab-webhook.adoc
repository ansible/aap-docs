...
.. Go to your instance, and link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html-single/using_automation_execution/controller-credentials/ref-controller-credential-gitLab-pat[Create a new credential for the GitLab PAT] using the generated token.
