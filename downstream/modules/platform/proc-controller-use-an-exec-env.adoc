...
Select a built and registered {ExecEnvShort} image when configuring a job template. 
Using this container helps ensure your automation runs with the precise dependencies and content required.
