...
//For information about the syntax to use, see link:https://docs.ansible.com/projects/ansible/latest/user_guide/collections_using.html#install-multiple-collections-with-a-requirements-file[Using Ansible collections] in the Ansible documentation.
+
...
//* link:https://docs.ansible.com/projects/ansible/latest/user_guide/collections_using.html[Using Ansible Collections]. 

//For more information about how Red Hat publishes one of these official collections, which can be used to automate your install directly, see the link:https://github.com/ansible/awx/blob/devel/awx_collection/README.md[AWX Ansible Collection] documentation. 
