...
* Provide a reachable IP address or fully qualified domain name (FQDN) for the `[automationhub]` host to ensure that users can synchronize and install content from {HubNameMain} from a different node. 
