...
* For more information about user roles, see link:{BaseURL}}red_hat_ansible_automation_platform/{PlatformVers}/html-single/access_management_and_authentication/index#gw-managing-access[Managing access with role based access control].
