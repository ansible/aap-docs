...
With {ControllerNameStart} you can watch playbooks run in real time, seeing each host as they check in.
...
Use {ControllerNameStart} to access your favorite projects and re-trigger execution from the web interface.
...
With {ControllerNameStart} you can:
...
Use {ControllerNameStart} to define your application deployment workflows, and then re-use them in many environments.
