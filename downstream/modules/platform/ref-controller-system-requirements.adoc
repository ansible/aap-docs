...
* For more information about obtaining an {ControllerName} subscription, see link:{URLControllerUserGuide}/controller-managing-subscriptions#controller-importing-subscriptions[Importing a subscription].
