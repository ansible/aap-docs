...
For more information on syncing or using custom inventory scripts, see link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/automation_controller_administration_guide/assembly-inventory-file-importing#doc-wrapper[Inventory file importing] in the _{ControllerAG}_.
