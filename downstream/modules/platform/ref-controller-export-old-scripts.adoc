...
They are all directly executabl. 
...
In the above example, you can `cd` into `my_scripts` and then issue a `git init` command, add the scripts you want, push it to source control,
