...
If you leave this field blank, only the default references are fetched (for example, branches under `refs/heads/`).
...
//* link:https://docs.ansible.com/projects/ansible/latest/modules/git_module.html[Ansible git module]
