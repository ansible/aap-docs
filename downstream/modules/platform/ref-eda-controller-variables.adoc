...
| `automationnedacontroller_pg_host` | `eda_pg_host` | The hostname of the PostgreSQL database used by {EDAcontroller}, which can be an externally managed database.
