...
[role="_abstract"]
Use the following procedure to create a new schedule for a job template, workflow job template, inventory source, project sync, or management job template.
