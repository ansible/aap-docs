...
.. In the *Note* field, enter a brief description about what this PAT is be used for.
...
. When your webhook is configured, it displays in the list of webhooks active for your repository, along with the ability to edit or delete it.
