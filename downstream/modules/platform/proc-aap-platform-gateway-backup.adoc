...
* The *{PlatformNameShort}* instance is deployed using the {OperatorPlatform}.
...
+
NOTE: When creating the *{PlatformNameShort} Backup* resource it also creates backup resources for each of the nested components that are enabled.
+
