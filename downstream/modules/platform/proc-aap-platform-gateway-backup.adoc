...
This will result in an *AnsibleAutomationPlatformBackup* resource. The following is an example of what the resource YAML will look like:
...
The status for the following instances should state *Running* or *Successful*:
