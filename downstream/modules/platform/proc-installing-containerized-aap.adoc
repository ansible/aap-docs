...
Installation is based around an  *inventory* file. This file defines the hosts/containers to be used and created, along with the variables for components and other information. This allows you to customize the installation.

For convenience we have added an example inventory file, which you can copy and simply amend to get started quicker.

In the collection directory you will find the boilerplate inventory file. Follow the instructions within the file to complete your configuration.
...
You are now ready to install containerized AAP using this command:
...
To receive more information than the standard output, you can increse the verbosity, up to a four v depth, *-vvvv*. This can significantly increase installation time so we recommend only using it when needed or requested by Red Hat support.