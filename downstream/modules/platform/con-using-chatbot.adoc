...
[NOTE]
====
If you are using an IBM Granite 3.3 series AI model, you might experience a delay of approximately one minute when waiting for a chat response. To resolve this error, restart the chat session.
====
