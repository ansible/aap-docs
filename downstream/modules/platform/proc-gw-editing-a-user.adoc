...
You can change user account properties after creation, including password, user type, and organizational assignment. 
Only platform administrators and organization administrators can change a user's email address. 
