...
= Inspecting a Kubernetes resource

To inspect a Kubernetes resource, you must use the `oc` command to get a summary or the full YAML definition of the resource.
