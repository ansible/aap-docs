...
`registry.redhat.io/ansible-automation-platform-21/ansible-builder-rhel8`. This makes the ansible-builder-rhel8 image available in the {PrivateHubName} registry along with the default {ExecEnvShort} images.
