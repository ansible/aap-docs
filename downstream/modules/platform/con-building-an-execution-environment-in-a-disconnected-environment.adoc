...
* For more information on importing collections from {Galaxy} or {HubName} into a {PrivateHubName}, see xref:importing-collections-into-private-automation-hub_disconnected-installation[Importing Collections into {PrivateHubName}].

* For more information on IP addresses for cdn.redhat.com, see link:https://access.redhat.com/articles/1525183[Public CIDR Lists for Red Hat].