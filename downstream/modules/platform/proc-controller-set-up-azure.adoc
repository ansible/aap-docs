...
[NOTE]
====
Groups coming from {MSEntraID} use unique IDs instead of group names. When creating group maps for an {MSEntraID} authenticator you must use the unique IDs.
