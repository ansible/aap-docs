...
.Verification
To verify that the authentication was configured correctly, logout of {ControllerName} and the login screen displays the Microsoft Azure logo to allow logging in with those credentials:

image::ag-configure-auth-azure-logo.png[Azure AD logo]

.Additional resources
For application registering basics in Azure AD, refer to the link:https://learn.microsoft.com/en-us/entra/identity-platform/v2-overview[What is the Microsoft identity platform?] overview.
