...
For more information, see the link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/installing_on_virtual_machines/platform-system-requirements[Red Hat Ansible Automation Platform system requirements].
