...
* For details on creating a Satellite environment on a disconnected network see link:{BaseURL}/red_hat_satellite/6.14/html/installing_satellite_server_in_a_disconnected_network_environment/index[Installing Satellite Server in a Disconnected Network Environment]. 
