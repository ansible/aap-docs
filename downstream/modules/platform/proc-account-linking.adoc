...
After you have migrated your user account, you can manage your account from the btn:[Access Management] menu. See link:{URLCentralAuth}/gw-managing-access[Managing access with role based access control]. 
