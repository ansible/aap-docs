...
[role="_abstract"]
Regularly updating your projects ensures your {PlatformNameShort} environment is synchronized with the latest versions of playbooks, roles, and collections from your integrated SCM repositories.
