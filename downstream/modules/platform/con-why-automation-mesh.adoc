...
For information about {AutomationMesh} and the various ways to design your {AutomationMesh} for your environment, see the https://access.redhat.com/documentation/en-us/red_hat_ansible_automation_platform/{PlatformVers}/html/red_hat_ansible_automation_platform_automation_mesh_guide/index[{PlatformName} {AutomationMesh} guide].
