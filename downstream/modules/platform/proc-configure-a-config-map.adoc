...
+
. Click btn:[Create].
. To verify that the ConfigMap was created and the `metrics-utility` is installed, from the navigation panel, select menu:ConfigMap[] and look for your ConfigMap in the list.
