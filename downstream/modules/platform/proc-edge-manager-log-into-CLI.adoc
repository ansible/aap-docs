...
How you log in the Red Hat Edge Manager depends on whether you choose the link:{URLEdgeManager}/assembly-edge-manager-install#edge-manager-oauth-auto[automatic] or link:link:{URLEdgeManager}/assembly-edge-manager-install#edge-manager-oauth-manually[manual] method when you initially set up the application.
