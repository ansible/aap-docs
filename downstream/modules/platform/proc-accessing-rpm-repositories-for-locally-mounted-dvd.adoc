...
[role="_abstract"]
In disconnected or air-gapped environments, you can install {PlatformNameShort} by using packages from a locally mounted RHEL DVD or ISO image. Learn how to mount the media and configure yum repositories to access BaseOS and AppStream packages for offline installation.
