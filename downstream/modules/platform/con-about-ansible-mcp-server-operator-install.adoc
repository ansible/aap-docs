...
Telemetry data will be automatically collected for Ansible MCP server deployments using Ansible Automation Platform version 2.6.20260121 and later. Red Hat will use this data to monitor the operational health of your MCP servers and to ensure the long-term scalability of the MCP ecosystem.
