...
. Follow the steps in link:{URLContainerizedInstall}/preparing-containerized-installation#installing-containerized-aap[Installing containerized {PlatformNameShort}] to install containerized {PlatformNameShort} and verify your installation.
