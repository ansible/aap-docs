...
[role="_abstract"]
Workflows in {ControllerName} allow you to string together multiple job templates and other workflows into a single job run. 
This section describes several workflow scenarios and considerations to remember when building workflows.
