...
For more information and example scenarios, see xref:{LinkControllerUserGuide}/controller-instance-and-container-groups#controller-group-policies-automationcontroller[Group policies for `automationcontroller`].
