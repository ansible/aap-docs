...
If you are selecting more than one role in this step, consider creating a custom role that includes all the permissions for this resource typo to give the team the correct access (LINK)
====
+
