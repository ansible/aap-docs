...
ifdef::mesh-VM[]
For further information, see link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/installing_on_virtual_machines/assembly-platform-install-scenario[Installing {PlatformName}]
endif::mesh-VM[]
ifdef::aap-install[]
