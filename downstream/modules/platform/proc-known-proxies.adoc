...
[id="proc-known-proxies_{context}"]
...
If {ControllerName} is reachable without use of the load balancer, or if the proxy does not validate the header, the value of `X-Forwarded-For` can be falsified to fake the originating IP addresses.
