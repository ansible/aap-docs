...
[role="_abstract"]
Configure inventory files to install a highly available {HubName} with clustered nodes and dedicated database hosts. This clustered setup uses load balancing to support enterprise-scale automation and ensure consistent system uptime.
