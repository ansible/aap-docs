...
Rather than having to copy and paste one into {ControllerName}, it is pulled directly from source control and then executed.
The script must be written to handle any credentials required for its task. 
