...
[role="_abstract"]
Review system requirements to ensure your environment supports RPM installation of {PlatformNameShort}. RPM-based installations of {PlatformNameShort} was deprecated in 2.5 and will be removed in version 2.7.
