...
You can synchronize collections and {ExecEnvShort} images from Red Hat cloud automation hub, storing and serving your own custom automation collections and execution images.
