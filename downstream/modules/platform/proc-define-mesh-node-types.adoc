...
[Note]
====
OpenSSL is required for this playbook you can verify it is installed via: 
----
openssl -v 
----
If it returns a version OpenSSL is installed otherwise you need to install OpenSSL with
----
