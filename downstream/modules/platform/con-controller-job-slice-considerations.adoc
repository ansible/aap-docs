...
Normally, the number of slices is equal to or less than the number of hybrid or execution nodes. You can limit a job template to certain instances through its instance groups. 
