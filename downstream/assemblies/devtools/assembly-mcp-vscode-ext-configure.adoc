...
ifdef::parent-context-of-mcp-vscode-ext-enable[:context: {parent-context-of-mcp-vscode-ext-enable}]
ifndef::parent-context-of-mcp-vscode-ext-enable[:!context:]
