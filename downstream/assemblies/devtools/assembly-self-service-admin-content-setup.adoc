...
= Setting up content management in {SelfServiceShort}

:context: self-service-admin-content-setup
[role="_abstract"]
Configure content discovery and catalog functionality in {SelfServiceShort} to enable users to sync repositories, discover execution environments, and browse collections.
