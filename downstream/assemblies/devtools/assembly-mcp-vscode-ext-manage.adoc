...
ifdef::parent-context-of-mcp-vscode-ext-manage[:context: {parent-context-of-mcp-vscode-ext-manage}]
ifndef::parent-context-of-mcp-vscode-ext-manage[:!context:]
