...
include::modules/con-devtools-plan-roles-collection.adoc[leveloffset=+1]

include::modules/con-devtools-roles-collection-prerequisites.adoc[leveloffset=+1]

include::modules/proc-devtools-scaffold-roles-collection.adoc[leveloffset=+1]

include::modules/proc-devtools-migrate-existing-roles-collection.adoc[leveloffset=+1]

include::modules/proc-devtools-create-new-role-in-collection.adoc[leveloffset=+1]

include::modules/proc-devtools-docs-roles-collection.adoc[leveloffset=+1]
...
include::modules/proc-devtools-publish-roles-collection-pah.adoc[leveloffset=+1]

include::modules/proc-devtools-use-roles-collections-aap.adoc[leveloffset=+2]
