...
include::modules/proc-rhdh-uninstall-ocp-operator-plugins-cm.adoc[leveloffset=+1]

// app-config-rhdh ConfigMap
include::modules/proc-rhdh-uninstall-ocp-operator-rhdh-cm.adoc[leveloffset=+1]

// Remove Custom resource ConfigMap from the {RHDHShort} Operator Custom Resource
include::modules/proc-rhdh-uninstall-ocp-operator-sidecar-container.adoc[leveloffset=+1]
