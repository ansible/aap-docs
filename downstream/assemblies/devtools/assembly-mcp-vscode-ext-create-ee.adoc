...
ifdef::parent-context-of-mcp-vscode-ext-create-ee[:context: {parent-context-of-mcp-vscode-ext-create-ee}]
ifndef::parent-context-of-mcp-vscode-ext-create-ee[:!context:]
