...
A certified collection means that Red Hat and partners have a strategic relationship in place and are ready to support joint customers. Collections might also have had additional testing and validation done against them.
...
include::hub/proc-revoking-token.adoc[leveloffset=+1]
