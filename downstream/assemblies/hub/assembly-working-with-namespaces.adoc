...
For instructions on how to create a team to manage access to your collections, see link:{URLCentralAuth}/index#assembly-controller-teams_gw-manage-rbac[Teams] in the {TitleCentralAuth} guide.
// Create content developers procedure will need to be replaced with new access management procedure. -Hala 
