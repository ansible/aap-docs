...
Ensure that the network ports and protocols listed under link:{URLPlanningGuide}/network-ports-protocols_planning#ref-network-ports-protocols-firewalls[Network ports and protocols firewall], in the _Execution Environments (EE)_ section, are available to avoid problems pulling container images.
