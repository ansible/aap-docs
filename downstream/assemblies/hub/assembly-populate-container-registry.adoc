...
To populate your container registry, you need to push a container image to it. 
Complete the following steps to pull images from the Red Hat Ecosystem Catalog (registry.redhat.io), tag them, and push them to your {PrivateHubName} container registry.
