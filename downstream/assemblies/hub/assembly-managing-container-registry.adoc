...
[role="_abstract"]
Manage container image repositories in your {PlatformNameShort} infrastructure using the {HubName} container registry. 
{HubNameStart} provides the following features:
