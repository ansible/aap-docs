...
[role="_abstract"]
Configure user access for container repositories in your {PrivateHubName} to provide permissions that determine who can access and manage images in your {PlatformNameShort}.

== Prerequisites

* You can create groups and assign permissions in {PrivateHubName}.
