...
Role-based access control (RBAC) restricts user access based on their role within an organization to which they are assigned in {PlatformNameShort}. The roles in RBAC refer to the levels of access that users have to the {PlatformNameShort} components and resources. 
