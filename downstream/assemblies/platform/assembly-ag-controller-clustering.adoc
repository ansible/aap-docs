...
Also, you can group clustered instances into different pools or queues, called link:{BaseURL}/documentation/red_hat_ansible_automation_platform/{PlatformVers}/html/automation_controller_user_guide/controller-instance-groups[Instance groups] in _{ControllerUG}_.
...
For more information, see the link:{BaseURL}/documentation/red_hat_ansible_automation_platform/{PlatformVers}/html/automation_controller_user_guide/controller-instance-and-container-groups[Container and instance groups] in _{ControllerUG}_.
