...
* See xref:edge-manager-image-build[Building a _bootc_ operating system image for the {RedHatEdge}]
* See xref:edge-manager-images-special-considerations[Special considerations for building images].
...
* See link:https://bootc-dev.github.io/bootc/building/guidance.html[Generic guidance for building images] in the bootc documentation.

include::platform/con-edge-manager-build.adoc[leveloffset=+1]
