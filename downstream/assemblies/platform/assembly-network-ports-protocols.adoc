...
| 80/443 | TCP | HTTP/HTTPS | {ControllerNameStart} |  HA Proxy load balancer/Ingress Node | | `automationgatway_main_url` 
| 80/443 | TCP | HTTP/HTTPS | {HubNameStart} |  HA Proxy load balancer/Ingress Node | | `automationgatway_main_url` 
| 80/443 | TCP | HTTP/HTTPS | {EDAName} |  HA Proxy load balancer/Ingress Node | | `automationgatway_main_url` 
