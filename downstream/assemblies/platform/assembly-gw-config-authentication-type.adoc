...
include::platform/proc-gw-update-callback-urls.adoc[leveloffset=+1]

include::platform/con-gw-configure-auth-timeouts.adoc[leveloffset=+1]

include::platform/proc-gw-setting-timeout-values.adoc[leveloffset=+2]
