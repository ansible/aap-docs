...
<<<<<<< HEAD
<<<<<<< HEAD
. A subscription manifest that you can upload to the platform. See link:{URLCentralAuth}/index#assembly-aap-obtain-manifest-files[Obtaining a manifest file] for more information.
=======
* A subscription manifest that you can upload to the platform. 
>>>>>>> 959eb444 (Fixed  broken links in Installation Guide (#2259))
=======
* A subscription manifest that you can upload to the platform. 
>>>>>>> 959eb444 (Fixed  broken links in Installation Guide (#2259))
