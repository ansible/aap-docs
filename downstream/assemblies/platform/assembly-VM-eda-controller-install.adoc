[id=assembly-VM-eda-controller-install]

= Virtual Machine-based installation

If you have an existing {PlatformNameShort} 2.4 Virtual Machine (VM)-based installation of {ControllerName} (4.4 or 4.5), you can perform a new installation of {PlatformNameShort} 2.5 which has {EDAcontroller} 1.1 and configure the two installations to work together.
