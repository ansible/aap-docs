...
The default view for the *Execution Environments* page is collapsed (*Compact*) with thew {ExecEnvShort} name and its image name. Selecting the {ExecEnvShort} name expands the entry for more information.
