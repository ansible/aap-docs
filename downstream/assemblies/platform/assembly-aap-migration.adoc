...
// Was told to remove these sections as they are not a concern anymore if Openshift 3 is ignored. 
...
include::platform/proc-operator-locate-hub-encryption-key.adoc[leveloffset=+2]
