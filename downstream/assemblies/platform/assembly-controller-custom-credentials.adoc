...
As a system administrator, you can define a custom credential type in a standard format using a YAML/JSON-like definition,
...
Only one AWS credential or one GCE credential, etc., are permitted. 
