...
ifdef::controller-UG[]
These include Git, Subversion, Mercurial and {RHLightspeed}.

For more information on creating a {RHLightspeed} project, see xref:controller-setting-up-insights[Setting up {RHLightspeed} Remediations].
