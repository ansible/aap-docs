...
* Because it has dependencies that are currently running so it has to wait until they are done or there is 
* Not enough capacity to run in the locations it is configured to.
...
include::platform/ref-projects-galaxy-support.adoc[leeveloffset=+1]
