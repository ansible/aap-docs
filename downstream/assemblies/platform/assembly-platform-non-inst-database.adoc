...
Access to a container registry enables you to load {ExecEnvName} onto the {PlatformNameShort}, giving you a consistent and containerized environment for executing Ansible playbooks and roles.
