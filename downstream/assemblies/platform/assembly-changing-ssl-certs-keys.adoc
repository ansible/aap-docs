...
include::platform/proc-change-tls-certs-installer.adoc[leveloffset=+1]

include::platform/proc-change-ssl-controller-ocp.adoc[leveloffset=+1]

include::platform/proc-change-ssl-hub-ocp.adoc[leveloffset=+1]

include::platform/proc-renew-ssl-cert.adoc[leveloffset=+1]

include::platform/proc-change-ssl-installer.adoc[leveloffset=+1]

include::platform/proc-change-ssl-manual-rpm.adoc[leveloffset=+1]
