...
For more information about the components provided with {PlatformNameShort}, see link:{URLPlanningGuide}/ref-platform-components[{PlatformName} components] in {TitlePlanningGuide}. 
