...
* xref:ref-standlone-controller-hub-ext-database-inventory_platform-install-scenario[Single {HubName} with external (installer managed) database]
...
* xref:ref-single-controller-hub-eda-with-managed-db[]
...
include::platform/ref-connect-hub-to-rhsso.adoc[leveloffset=+3]
...
include::platform/ref-single-controller-hub-eda-with-managed-db.adoc[leveloffset=+2]
//[ifowler] Removed for AAP-18700 Install Guide Scenario Consolidation  
