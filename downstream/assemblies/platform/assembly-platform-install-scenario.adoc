...
* link:{URLInstallationGuide}/appendix-inventory-files-vars[Inventory file variables]
...
include::platform/proc-ha-hub-installation.adoc[leveloffset=+3]
...
//include::platform/proc-backup-aap.adoc[leveloffset=+1] Replacing with new chapter on backup/recovery centrally stored in the RPM install and RPM upgrade guides for 2.5 2.6; RPM will be obsolete for 2.7
