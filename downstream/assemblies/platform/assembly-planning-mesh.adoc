...
The document covers the setting up of {AutomationMesh} on operator-based deployments for Kubernetes based containers, such as OpenShift Container Platform and {PlatformNameShort} on {Azure} managed application. 
endif::operator-mesh[]
