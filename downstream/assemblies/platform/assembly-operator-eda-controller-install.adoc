ifdef::context[:parent-context-of-assembly-operator-eda-controller-install: {context}]

:_mod-docs-content-type: ASSEMBLY

ifndef::context[]
[id="assembly-operator-eda-controller-install"]
endif::[]
ifdef::context[]
[id="assembly-operator-eda-controller-install_{context}"]
endif::[]

:context: assembly-operator-eda-controller-install
...
include::platform/proc-operator-connect-eda-to-controller.adoc[leveloffset=+1]

ifdef::parent-context-of-assembly-gs-auto-op[:context: {parent-context-of-assembly-operator-eda-controller-install}]
ifndef::parent-context-of-assembly-operator-eda-controller-install[:!context:]
