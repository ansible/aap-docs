...
Logging provides the capability to send detailed logs to several kinds of third-party external log aggregation services.
Services connected to this data feed serve as a useful means of gaining insight into {ControllerName} use or technical trends. 
