...
From this screen you can launch image:rightrocket.png[Launch icon,15,15] , edit image:leftpencil[Edit icon,15,15], and duplicate image:copy.png[Duplicate icon] a workflow job template.
