...
Credentials authenticate the {ControllerName} user when launching jobs against machines, syncronizing with inverrntory sources, and importing project content from a version control system.
...
For further information, see the Automation Controller Administration Guide.
====
