...
include::platform/proc-controller-multi-cred-machine-network.adoc[leveloffset=3]
...
//[Jonquil] The following Terraform module is for 2.6 and later:
include::platform/ref-controller-credential-terraform-hcp.adoc[leveloffset=+2]
