...
//emurtoug to add these modules for 2.6 on the nov 19 code release, not relevant for 2.5
//include::platform/proc-enable-configure-metrics-utility-inventory-file.adoc[leveloffset=+3]
//include::platform/proc-applying-your-metrics-utility-config.adoc[leveloffset=+3]

//emurtoug to remove these modules for 2.6 on the nov 19 code release, still relevant in 2.5
