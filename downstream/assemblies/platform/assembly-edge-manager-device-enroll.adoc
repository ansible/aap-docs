[id="assembly-edge-manager-device-enroll"]

= Device enrollment

You need to enroll devices to a {RedHatEdge} service before you can start managing them. 
...
include::platform/con-edge-manager-enroll-meth.adoc[leveloffset=+1]
