...
= About the installation program inventory file

[role="_abstract"]
Configure your {PlatformNameShort} installation by defining hosts, groups, and deployment scenarios in the inventory file.
