...
. For more information on available topologies, see link:{BaseURL}/red_hat_ansible_automation_platform/{PlatformVers}/html/tested_deployment_models[Tested deployment models]. 
