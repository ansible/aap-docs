...
[role="_abstract"]
Track all changes made to any object in automation controller by reviewing the Activity Stream. This allows you to audit the time, the user, and the specific action for every event.
