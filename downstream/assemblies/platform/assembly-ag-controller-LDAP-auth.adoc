...
Note that new users are still created and get their attributes pushed to the database on their first login.

[WARNING]
====
With this option set to `False`, no changes to LDAP user's attributes are updated. 
