...
= Configuring an external (customer provided) PostgreSQL database
...
* {PlatformName} requires customer provided (external) database to have International Components for Unicode (ICU) support.
