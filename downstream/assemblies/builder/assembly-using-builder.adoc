...
include::platform/creating-the-custom-execution-environment-definition.adoc[leveloffset=+1]
...
include::platform/proc-update-ee-image-locations.adoc[leveloffset=+2]
