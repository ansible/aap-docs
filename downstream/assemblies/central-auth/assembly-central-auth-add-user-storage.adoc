...
|Allow Kerberos authentication|Enable Kerberos/SPNEGO authentication in the realm with users data provisioned from LDAP. See link:{BaseURL}/red_hat_single_sign-on/{RHSSOVers}/html/server_administration_guide/configuring-authentication_server_administration_guide#kerberos[Kerberos] for more information.
|===
