...
To create your own decision environment, see xref:ref-controller-install-builder[Install ansible-builder] and xref:eda-build-a-custom-decision-environment[Building a custom decision environment for Event-Driven Ansible within Ansible Automation Platform].
