...
The rulebooks of a project must be located in the path defined for {EDAName} content in Ansible collections: `/extensions/eda/rulebooks` or just `/rulebooks` at the root of the project.
