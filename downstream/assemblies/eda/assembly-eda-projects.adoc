...
They must be a git repository and located in the path defined for {EDAName} content in Ansible collections, `/extensions/eda/rulebooks`, at the root of the project.
