...
//[JMS] Moving this section to Chapter 5 Decision environments, per AAP-48005. Overhauling the content to be relevant for decision environments and rulebooks/activations.
