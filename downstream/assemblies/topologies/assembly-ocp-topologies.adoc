...
[role="_abstract"]
{PlatformNameShort} provides tested topologies for {PlatformNameShort} on Red Hat OpenShift. Select the topology that best fits your Operator-based deployment requirements.
