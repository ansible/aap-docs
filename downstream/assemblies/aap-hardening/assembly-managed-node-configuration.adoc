...
This chapter provides recommendations on improving the security posture of the managed nodes automated by {PlatformNameShort}, including the remote connections between Ansible Automation Platform and the managed nodes.  
