...
. Run {ControllerName} backup included in the {ControllerName} setup playbook. See link:https://legacy-controller-docs.ansible.com/ansible-tower/3.8.3/html/administration/backup_restore.html#ag-backup-restore[Backing up and restoring {ControllerName}] in the _Automation Platform Administration Guide_ for details.
...
See link:https://legacy-controller-docs.ansible.com/ansible-tower/latest/html/administration/backup_restore.html[Backing up and restoring {ControllerName}].
