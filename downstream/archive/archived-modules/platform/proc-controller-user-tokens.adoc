...
Before you add a token for your user, you might want to link:https://legacy-controller-docs.ansible.com/automation-controller/latest/html/userguide/applications_auth.html#ug-applications-auth-create[Create an application] if you want to
