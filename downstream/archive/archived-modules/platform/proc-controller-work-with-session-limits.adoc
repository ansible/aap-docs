...
. Click btn:[Edit].
. Edit the *Maximum number of simultaneous logged in sessions* setting or use the link:https://legacy-controller-docs.ansible.com/automation-controller/4.4/html/controllerapi/browseable.html#api-browsable-api[Browsable API] if you are comfortable with making REST requests.
+
[NOTE]
====
