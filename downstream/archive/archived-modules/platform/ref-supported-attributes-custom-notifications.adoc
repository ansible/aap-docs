...
[id="ref-supported-attributes-custom-notifications_{context}"]
////
...
[role="_abstract"]
This section describes the list of supported job attributes and the proper syntax for constructing the message text for notifications.
