...
See https://legacy-controller-docs.ansible.com/ansible-tower/latest/html/userguide/job_templates.html#surveys[Surveys] in the Ansible Tower _User Guide_ for more information on updating job template surveys.
