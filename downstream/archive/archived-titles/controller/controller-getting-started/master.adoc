...
You can use any sort of system manageable by Ansible, as described in the link:https://docs.ansible.com/projects/ansible/latest/user_guide/basic_concepts.html#managed-nodes[Managed nodes] section of the Ansible documentation.
