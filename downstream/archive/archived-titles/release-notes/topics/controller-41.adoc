...
See https://legacy-controller-docs.ansible.com/automation-controller/latest/html/release-notes/relnotes.html#release-notes-for-4-x[Automation controller Release Notes for 4.x] for a full list of new features and enhancements.
