...
Ansible Automation Platform can be installed in various ways by choosing the best mode for your environment and making any necessary modifications to the inventory file. See https://legacy-controller-docs.ansible.com/ansible-tower/latest/html/installandreference/tower_install_wizard.html[Installing Ansible Automation Platform] for more information.
