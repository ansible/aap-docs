...
[IMPORTANT]
====
The {RedHatEdge} documentation has moved to a standalone location. For the most current documentation, see link:https://docs.redhat.com/en/documentation/red_hat_edge_manager/1.0/[Red Hat Edge Manager 1.0]. 
The content in this guide is deprecated. 
====
