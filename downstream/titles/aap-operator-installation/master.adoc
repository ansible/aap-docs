...
// [sayjadha]Added the Ansible MCP server deployment info. in OCP install guide.
include::platform/assembly-deploy-ansible-mcp-server-operator-install.adoc[leveloffset=+1]
...
include::platform/assembly-aap-backup-database-compression-for-operator-based-deployments.adoc[leveloffset=+1]
