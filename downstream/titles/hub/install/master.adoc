...
Choose the {PlatformNameShort} installer you need to install {PrivateHubName} based on your {RHEL} environment internet connectivity.
...
Install {PrivateHubName} using the {PlatformNameShort} installer if your {RHEL} environment is connected to the internet.
