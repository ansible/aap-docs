...
The RPM installer will be supported for {RHEL} 9 during the lifecycle of {PlatformNameShort} {PlatformVers} to support migrations to existing supported topologies. Users are encouraged to migrate to the containerized topology on {RHEL} or to the {OCPShort} Operator installation method. See the support matrix for more information on upgrade and migration paths.
