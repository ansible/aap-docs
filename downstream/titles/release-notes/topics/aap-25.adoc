...
For more information, see _link:{LinkPluginRHDHInstall}_. 
...
{SelfService} aims to provide a self-service experience, making automation simpler and easily accessible to users of any skill level and role. It also offers accelerated deployment of common automation use cases.
...
For more information, see _link:{LinkSelfServiceInstall}_.
