...
* With this update, {PlatformNameShort} 2.4 uses Python 3.11. Before this update, {PlatformNameShort} 2.4 used {Python}, which reaches end of life on RHEL 8 in November 2025.(AAP-53469)
