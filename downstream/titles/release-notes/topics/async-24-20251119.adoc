...
* With this update, {PlatformNameShort} 2.4 uses {Python}. Before this update, {PlatformNameShort} 2.4 used Python 3.9, which reaches end of life on RHEL 8 in November 2025.(AAP-53469)

[IMPORTANT]
==== 
All users must download the latest version of the installation program. Attempting to install or upgrade {PlatformNameShort} 2.4 with a previous version of the installation program will fail.
====
