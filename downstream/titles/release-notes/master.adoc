...
This release includes several enhancements, additions, and fixes that have been implemented in the Red Hat Ansible Automation Platform.

include::topics/aap-24.adoc[leveloffset=+2]

include::topics/hub-470.adoc[leveloffset=+2]
...
include::topics/creator-tools-24.adoc[leveloffset=+2]
