...
* Fixed an issue where the *Postgresql SSL* mode variables for controller, {EDAName}, gateway and hub were not validated during the preflight role execution. (AAP-37352)
