...
* Fixed an issue where users who existed in {PlatformNameShort} 2.5 with controller legacy authentication, but never logged were unable to attempt authentication with controller in {PlatformNameShort} 2.6, and were left in an unusable state.(AAP-56388)
