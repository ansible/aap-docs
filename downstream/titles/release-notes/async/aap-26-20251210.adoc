...
| Modify the `AnsibleAutomationPlatform` kind value and then wait for the changes to become effective.
...
* Fixed an issue where the collection hyperlink was broken in card view in private {HubName}.(AAP-49006)
