...
Automation Services Catalog is dependent on and integrated with Ansible Tower server in the {PlatformNameShort}. The following table details supported versions of Ansible Tower server for use with *all* versions of Automation Services Catalog.
