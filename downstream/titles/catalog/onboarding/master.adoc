...
Automation Service Catalog is a service within the {PlatformName}.

Automation Service Catalog enables customers to organize and govern product catalog sources on Ansible Tower across various environments.
...
. Go to the “{PlatformName}” tile then to Settings ➔ User Access Management.
