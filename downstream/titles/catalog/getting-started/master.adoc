...
{CatalogNameStart} is a service within the {PlatformName}.
{CatalogNameStart} enables customers to organize and govern product catalog sources on Ansible Tower across various environments.
