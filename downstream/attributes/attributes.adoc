...
:RHLightspeed: Red Hat Lightspeed 
// Red Hat Lightspeed is the rebranding of Insights
...
// Insights
:InsightsName: Red Hat Lightspeed for Red Hat Ansible Automation Platform
:InsightsShort: Red Hat Lightspeed for Ansible Automation Platform
...
:RHDHVers: 1.6
:RHDHShort: RHDH
:SelfService: Ansible automation portal
:SelfServiceShort: Ansible automation portal
:SelfServiceShortStart: Ansible automation portal
...
:MenuAMAPITokens: menu:{MenuAM}[API Tokens]
...
:CustomerSupport: link:https://access.redhat.com/support/cases/?extIdCarryOver=true&sc_cid=RHCTG0250000454096#/case/new/get-support?caseCreate=true[Customer support]
...
:TitleSelfServiceInstall: Installing Ansible automation portal
...
:TitleSelfServiceUsing: Using Ansible automation portal
