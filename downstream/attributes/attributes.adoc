...
:MenuTopAE: From the {MenuAE} menu on the navigation panel, select
:MenuTopAC: From the {MenuAC} menu on the navigation panel, select
...
:MenuADRuleAudit: menu:Automation Decisions[Rule Audit]
:MenuADRulebookActivations: menu:Automation Decisions[Rulebook Activations]
:MenuADProjects: menu:Automation Decisions[Projects]
:MenuADDecisionEnvironments: menu:Automation Decisions[Decision Environments]
...
//:MenuADministration-activity-stream: menu:Automation Controller[Views > Activity Stream]
//:menu_savings-plan: menu:Automation Analytics[Savings Planner]
//:menu_clusters: menu:Automation Analytics[Clusters]
:MenuAAReports: menu:Automation Analytics[Reports]
:MenuAAAutomationCalc: menu:Automation Analytics[Automation Calculator]
:MenuAAAnalyticsBuilder: menu:Automation Analytics[Analytics builder]
:MenuAAHostMetrics: menu:Automation Analytics[Host Metrics]
:MenuAAHostSubscriptionUse: menu:Automation Analytics[Subscription Usage]

// Access Management menu selections
// First include attribute
:MenuAMAuthentication: menu:Access Management[Authentication]
:MenuAMOrganizations: menu:Access Management[Organizations]
:MenuAMTeams: menu:Access Management[Teams]
:MenuAMUsers: menu:Access Management[Users]
:MenuAMRoles: menu:Access Management[Roles]
:MenuAMCredentials: menu:Access Management[Credentials]
:MenuAMCredentialType: menu:Access Management[Credential Types]


// Ansible Lightspeed menu selections
// --- the following is not in the current build but may be added later ---
//:MenuALSeatManagement: menu:Ansible Lightspeed[Seat Management]
