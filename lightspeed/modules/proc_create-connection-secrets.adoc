...
This key controls whether the anonymization of Personally Identifiable Information (PII) is enabled. PII includes passwords, IP addresses, email addresses, and other sensitive data.
