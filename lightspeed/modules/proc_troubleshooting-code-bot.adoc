...
Run a manual scan on your git repositories by adding the *ansible-code-bot-scan* topic to your repository. For more information, see xref:proc_manually-scan-repo[Manually scan your Git repositories].
