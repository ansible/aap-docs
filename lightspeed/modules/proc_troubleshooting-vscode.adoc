...
To resolve this error, ensure that your {ibmwatsonxcodeassistant} plan supports tuning of custom models. Refer to your IBM Cloud account and select an upgrade option. 