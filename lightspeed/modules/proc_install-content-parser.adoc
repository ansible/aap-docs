...
** To generate a training data set without ansible-lint preprocessing, go to section xref:generate-training-data-set_configuring-custom-models[Generating a custom model training data set]. 
