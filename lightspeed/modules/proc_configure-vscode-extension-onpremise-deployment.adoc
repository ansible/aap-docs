...
* In the *URL for Ansible Lightspeed* field, enter the *Route URL* of the {LightspeedShortName} on-premise deployment. The Ansible users must have AAP controller credentials. 
