...
Obtain the WCA key and model ID of your model from {ibmwatsonxcodeassistant}, which you can use later to authenticate and connect your instance of {ibmwatsonxcodeassistant} with {LightspeedShortName}. 
