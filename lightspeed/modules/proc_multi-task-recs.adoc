...
+
NOTE: If you reject a recommendation, you can modify the prompt and review the generated code recommendations once again to match your task intent. For more information, see xref:con_overview-and-best-practices.adoc[Impact of accepting or rejecting code recommendations on the training model].
+
...
* xref:module[Troubleshooting Ansible Visual Studio Code extension errors]
* xref:module[Troubleshooting {AnsibleCodeBot} errors]
