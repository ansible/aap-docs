...
* You must have installed the Ansible VS Code extension. For the steps, see xref:install-vscode-extension_configuring-with-code-assistant[Installing the Ansible VS Code extension].
* You must have configured the Ansible VS Code extension to enable {LightspeedShortName}. For the steps, see xref:configure-vscode-extension_configuring-with-code-assistant[Configuring the Ansible VS Code extension].
