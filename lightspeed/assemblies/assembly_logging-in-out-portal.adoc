...
|====
| *Scenario* | *Result*
|You are a {RHSSOshort} user with an assigned seat license. Note: This is the typical scenario for accessing as {LightspeedShortName} an Ansible user.| You are routed to the {LightspeedShortName} paid commercial offering.
...
|You are a {RHSSOshort} user without an assigned seat license.|You are identified as a community user and redirected to Red Hat {LightspeedTechPreview}, which is a free community model.
