...
[id="troubleshoot-ansible-vscode-errors_{context}"]

= Troubleshoot Ansible Visual Studio Code extension errors

:context: troubleshoot-ansible-vscode-errors
...
** To resolve this error, ensure that you have enabled the *Lightspeed:Enabled* and menu:Lightspeed[Suggestions:Enabled] settings. For more information, see xref:configure-vscode-extension_installing-ansible-vscode-extension[Configure the Ansible VS Code extension].
