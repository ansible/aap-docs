...
[id="troubleshooting-lightspeed-configuration-errors"]

= Troubleshoot {LightspeedShortName} configuration errors

:context: troubleshooting-lightspeed-configuration-errors
