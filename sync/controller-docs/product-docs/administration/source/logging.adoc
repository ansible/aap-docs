...
image:images/logging-splunk-tower-example.png[image]
...
image:images/logging-loggly-tower-example.png[image]
...
image:../../administration/source/images/logging_sumologic_main.png[image]
...
image:images/configure-tower-system-logging-splunk-example.png[image]
