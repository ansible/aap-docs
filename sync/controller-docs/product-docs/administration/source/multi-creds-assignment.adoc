...
image:../../userguide/source/images/credentials-create-multivault-credential.png[image]
...
image:../../userguide/source/images/job-template-include-multi-vault-credential.png[image]
...
image:../../userguide/source/images/credentials-create-novaultid-credential.png[image]
