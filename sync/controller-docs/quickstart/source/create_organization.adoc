...
image:../../userguide/source/images/organizations-home-showing-example-organization.png[Organizations
- default view]
...
clicking the Edit (image:images/edit-button.png[edit]) button and
entering the appropriate details, then save your changes.

image:images/qs-organization-list-view-edit-icon.png[image]

image:images/qs-organization-default-expand-properties.png[Organizations
- default expanded]
