...
image:images/qs-credentials-list-view.png[Credentials - list view]
...
image:images/qs-credentials-demo-details.png[Credentials - review demo
credential]
...
Edit (image:images/edit-button.png[edit]) button next to the credential
