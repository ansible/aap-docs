...
tooltip image:../../common/source/images/tooltips-icon.png[help] icon
...
image:../../common/source/images/configure-tower-jobs.png[image]
...
image:../../common/source/images/configure-tower-system.png[image]
