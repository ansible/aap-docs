...
image:images/settings-jobs-jinja.png[image]
...
image:../../common/source/images/configure-tower-system-misc-baseurl.png[image]
...
Rackspace, etc) return all instances available to the cloud credentials
...
image:../../common/source/images/configure-tower-jobs-callback.png[image]
...
image:images/edit-button.png[edit] button to the right of the group name
that contains the Windows servers. In the "variables" section, add your
connection information as such: `ansible_connection: winrm`
