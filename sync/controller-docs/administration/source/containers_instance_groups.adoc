...
image:images/instance-groups_list_view.png[Instance Group policy
example]
...
image:images/instance-groups-scenarios.png[Instance Group example]
_____________________________________________________________________________________________________________________________________________________________________________________
...
image:../../userguide/source/images/instance-group-create-new-cg.png[IG
- create new CG]
...
image:../../userguide/source/images/instance-group-customize-cg-pod.png[IG
- CG customize pod]

You may provide additional customizations, if needed. Click *Expand* to
view the entire customization window.

image:../../userguide/source/images/instance-group-customize-cg-pod-expanded.png[image]
...
image:../../userguide/source/images/instance-group-example-cg-successfully-created.png[IG
...
image:../../userguide/source/images/inventories-create-new-cg-test-inventory.png[Dummy
inventory]
...
image:../../userguide/source/images/inventories-create-new-cg-test-localhost.png[Inventory
with localhost]
...
image:../../userguide/source/images/inventories-launch-adhoc-cg-test-localhost.png[Launch
inventory with localhost]

image:../../userguide/source/images/inventories-launch-adhoc-cg-test-localhost2.png[image]

You can see in the jobs detail view the container was reached
successfully using one of ad hoc jobs.

image:../../userguide/source/images/inventories-launch-adhoc-cg-test-localhost-success.png[Inventory
...
image:../../userguide/source/images/instance-group-job-details-with-cgs.png[IG
- instances jobs]
...
image:../../userguide/source/images/instance-group-cg-job-details-error.png[image]
