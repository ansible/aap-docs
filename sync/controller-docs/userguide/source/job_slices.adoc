...
`ug_JobTemplates` for information on how to specify this, as well as the
number of job slices on your job template configuration.

The `ug_JobTemplates` section provides additional detail on performing
