...
If you do not want to learn the reStructuredText format, you can also https://github.com/ansible/ansible-lint/issues[file an issue], and let us know how we can improve our documentation.
