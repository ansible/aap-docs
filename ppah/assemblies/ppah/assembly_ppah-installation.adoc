...
* a xref:ppah-install-dev_ppah-installation[development option]
* a xref:ppah-install-ha_ppah-installation[production option]
...
include::ppah/proc_ppah-prepare-rhel-host.adoc[leveloffset=+1]
include::ppah/proc_ppah-install-ansible-core.adoc[leveloffset=+1]
include::ppah/proc_ppah-download-aap.adoc[leveloffset=+1]
include::ppah/proc_ppah-online-offline-install.adoc[leveloffset=+1]
include::ppah/proc_ppah-install-dev.adoc[leveloffset=+1]
include::ppah/proc_ppah-install-ha.adoc[leveloffset=+1]
//include::ppah/ref_ppah-config.adoc[leveloffset=+1]
include::ppah/ref_ppah-access.adoc[leveloffset=+1]
