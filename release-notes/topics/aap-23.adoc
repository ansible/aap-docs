...
* Added the ability to use external execution nodes when running Ansible Automation Platform as a managed service in Azure.
* Added the ability to use external execution nodes when running the Ansible Automation Platform Operator in Openshift.
