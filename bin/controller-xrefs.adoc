...
:containergroup-sa-file: link:https://raw.githubusercontent.com/ansible/aap-docs/main/sync/controller-docs/common/source/containergroup-sa.yml[containergroup-sa.yml]